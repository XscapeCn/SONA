...
public class Demo04GATest {
    public static void main(String[] args) throws IOException {
        BufferedReader br1 = new BufferedReader(new FileReader("H:/Nature/2020PreExperiment/result/GATest/genes.txt"));
        String str;
        ...
        System.out.println(geneList.get(0).size());
        System.out.println(geneList.get(0).get(0));


        BufferedReader br2 = new BufferedReader(new FileReader("H:/Nature/2020PreExperiment/result/GATest/expression.txt"));
        String str2;
        ...
        System.out.println(genExpression.get(0).size());
        System.out.println(genExpression.get(0).get(0));
