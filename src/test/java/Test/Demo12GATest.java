...
public class Demo12GATest {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("H:/Nature/2020PreExperiment/result/GATest/fps_GWAS.csv"));
        String str = null;
        ...
        for (int i = 0; i < sum.size(); i++) {
            if (sum.get(i).get(elIn).equals("SL")){
        ...
        for (int i = 0; i <  position.size(); i++) {
            String[] test = SNPMapping.mapping(chromosome.get(i), position.get(i), 3);
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("H:/Nature/2020PreExperiment/result/SR/SR_limma_44142_colrow.txt"));
        br1.readLine();
        ...
        BufferedWriter bw2 = new BufferedWriter(new FileWriter("H:/Nature/2020PreExperiment/result/GATest/expression.txt"));
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("H:/Nature/2020PreExperiment/result/GATest/genes.txt"));
