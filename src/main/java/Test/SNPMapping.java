...
//        return new int[]{-1};
    ...
    public static String[] mapping(String chr, int pos, int count){
        ...
        key.put("1A", 471304005);
        key.put("1B", 438720154);
        key.put("1D", 452179604);
        key.put("2A", 462376173);
        key.put("2B", 453218924);
        key.put("2D", 462216879);
        key.put("3A", 454103970);
        key.put("3B", 448155269);
        key.put("3D", 476235359);
        key.put("4A", 452555092);
        key.put("4B", 451014251);
        key.put("4D", 451004620);
        key.put("5A", 453230519);
        key.put("5B", 451372872);
        key.put("5D", 451901030);
        key.put("6A", 452440856);
        key.put("6B", 452077197);
        key.put("6D", 450509124);
        key.put("7A", 450046986);
        key.put("7B", 453822637);
        key.put("7D", 453812268);
        ...
        for (int i = 0; i < gf.getGeneNumber(); i++) {
            ...
            if (temp.contains(chr)){
                subGeneName.add(temp);
                int geneChromosome = gf.getGeneChromosome(gf.getGeneIndex(temp));
                int[] tt;
                if (geneChromosome%2 == 0){
                    tt = new int[]{gf.getGeneStart(i) + key.get(chr), gf.getGeneEnd(i) + key.get(chr)};
                }else{
                    tt = new int[]{gf.getGeneStart(i), gf.getGeneEnd(i)};
                }
                subGeneRange.add(tt);
            }
        }
        ...
        if (temp.length == 2){
            ...
            }else if (temp[0] > subGeneRange.get(subGeneRange.size() -1 )[1] - count){
                start = temp[0];
                end = subGeneRange.get(subGeneRange.size())[1];
            }else {
                start = temp[0] - count;
